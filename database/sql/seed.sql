...
INSERT INTO languages (language_name, iso_code, requested) VALUES ('eng', 'en', FALSE);
...
INSERT INTO tokens (token, reserved_token, start_index, end_index, token_language_id, type, uploaded_file_id) VALUES ('Lorem', TRUE, 0, 5, 1, 'manual', 1);
