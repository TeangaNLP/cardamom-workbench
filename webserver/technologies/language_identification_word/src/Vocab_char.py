...
#     inputs,raw_inputs, raw_seqs,targets = prepare_sentence(f'{slash}home{slash}kougos{slash}data{slash}language_detection_dataset{slash}supervised_code_model{slash}fasttext_k-means{slash}german_dataset.csv')
...
def read_data(file_path, stemming_arabic=False, new_preprocess=False):
    labels = ["AWA", "BHO", "BRA", "HIN", "MAG", "bg", "mk", "bs", "hr", "sr", "cz", "sk", "es_AR", "es_ES", "pt-BR", "pt-PT", "id", "my"]
