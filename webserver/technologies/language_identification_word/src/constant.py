...
parser.add_argument('--embedding_size_char_per_word', type=int,
                    default=300, help='embedding size char per word')
...
parser.add_argument('--emb_list', nargs='+', type=str,default=['embeddings/model_afr.vec', 'embeddings/model_eng.vec',
                                                               'embeddings/model_nbl.vec', 'embeddings/model_nso.vec',
                                                               'embeddings/model_sot.vec', 'embeddings/model_ssw.vec',
                                                               'embeddings/model_ts0.vec', 'embeddings/model_tsn.vec',
                                                               'embeddings/model_ven.vec', 'embeddings/model_xho.vec',
                                                               'embeddings/model_zul.vec'])
