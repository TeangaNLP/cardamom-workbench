...
def cardamom_tokenise(string, provenance=None, iso_code=None, reserved_toks=None, uploaded_file_id=None):
    ...
    if reserved_toks:
        ...
        for indset in reserved_toks:
            ...
            start_index = indset.start_index
            end_index = indset.end_index
    ...
    for token in token_list:
        ...
        if isinstance(token, str):
            ...
            tok_dict = TokenModel(reserved_token=False, start_index=tok_index, end_index=tok_index + len(token), token_language_id=iso_code, type_="auto", uploaded_file_id=uploaded_file_id)
        ...
        current_index = tok_dict.end_index
